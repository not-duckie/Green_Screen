'''
this script does all types of google dork to find if any sensitive data is exposed to web by this mentioned domain

Usage
python2 google_dork.py doamin_name
...
a = ['ext:(doc | pdf | xls | txt | ps | rtf | odt | sxw | psw | ppt | pps | xml) (intext:confidential salary | intext:\"budget approved\") inurl:confidential',
...
f = open('google_dork','wt')
for i in a:
    query = "site:"+sys.argv[1] + ' ' + i
    print query
    f.write("="*5+query+"="*5)
    for i in search(query, num=4, pause=10):
        if i :
            print(i)
            f.write(i+'\n')
